...
SCENE_PATH=${DATA_ROOT_DIR}/${DATASETS}/${SCENES}
...
--config configs/${DATASETS}/${SCENES}_${TRAIN_CONFIGS}_${TRAIN_VIEWS}_views.yaml \
--pcd_init ${TRAIN_CONFIGS} \
"

CMD_9="python ./render.py \
--model_path output/${DATASETS}/${SCENES}/${TRAIN_VIEWS}_views/${TRAIN_CONFIGS} \
--loaded_pth output/${DATASETS}/${SCENES}/${TRAIN_VIEWS}_views/${TRAIN_CONFIGS}/chkpnt30000.pth \
--pcd_init ${TRAIN_CONFIGS} \
"
...
echo "========= ${SCENES}: MVSFormer_Geometric_Initialization   ========="
# eval $CMD_1
# eval $CMD_2
# eval $CMD_3
# eval $CMD_4
# eval $CMD_5
# echo "========= ${SCENES}: Downsampling of Dense Points         ========="
# eval $CMD_6
# echo "========= ${SCENES}: DepthAnythingV2_For_Depth_Estimation ========="
# eval $CMD_7
# echo "========= ${SCENES}: Train_Render_and_Metrics             ========="
# eval $CMD_8
eval $CMD_9
eval $CMD_10
